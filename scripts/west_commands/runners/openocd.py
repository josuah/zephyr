...
class OpenOcdBinaryRunner(ZephyrBinaryRunner):
    ...
    def do_add_parser(cls, parser):
        ...
        parser.add_argument('--log-file',
                            default=None,
                            help='''Redirect log output to the given file (overwritten) using
    ...
    def do_create(cls, cfg, args):
        ...
        return OpenOcdBinaryRunner(
            ...
            telnet_port=args.telnet_port, log_output=args.log_file, gdb_port=args.gdb_port,
    ...
    def do_run(self, command, **kwargs):
        ...
        if self.log_output is not None:
            self.openocd_cmd += ['--log_output', self.log_output]
