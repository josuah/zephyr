...
static int usbh_uvc_parse_input_header(struct usbh_context *const uhs_ctx,
				       struct usbh_uvc_data *const uvc,
...
static int usbh_uvc_parse_output_header(struct usbh_context *const uhs_ctx,
					struct usbh_uvc_data *const uvc,
					struct uvc_stream_header_descriptor *const desc)
{
...
static int usbh_uvc_parse_format_uncomp(struct usbh_context *const uhs_ctx,
					struct usbh_uvc_data *const uvc,
...
static int usbh_uvc_parse_format_mjpeg(struct usbh_context *const uhs_ctx,
				       struct usbh_uvc_data *const uvc,
...
static int usbh_uvc_parse_frame(struct usbh_context *const uhs_ctx,
				struct usbh_uvc_data *const uvc,
...
static int usbh_uvc_parse_color(struct usbh_context *const uhs_ctx,
				struct usbh_uvc_data *const uvc,
...
static int usbh_uvc_removed(struct usbh_context *const uhs_ctx)
{
	LOG_DBG("%p", uhs_ctx);
...
static int usbh_uvc_rwup(struct usbh_context *const uhs_ctx)
{
	LOG_DBG("%p", uhs_ctx);
...
static int usbh_uvc_suspended(struct usbh_context *const uhs_ctx)
{
	LOG_DBG("%p", uhs_ctx);
...
static int usbh_uvc_resumed(struct usbh_context *const uhs_ctx)
{
	LOG_DBG("%p", uhs_ctx);
