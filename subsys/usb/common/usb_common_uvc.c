...
/* Mapping of UVC controls with video controls */

const struct uvc_control_map uvc_control_map_ct[] = {
	{
		.size = 1,
		.bit = 1,
...
const size_t uvc_control_map_ct_len = ARRAY_SIZE(uvc_control_map_ct);

const struct uvc_control_map uvc_control_map_pu[] = {
	{
		.size = 2,
		.bit = 0,
...
const size_t uvc_control_map_pu_len = ARRAY_SIZE(uvc_control_map_pu);

const struct uvc_control_map uvc_control_map_su[] = {
	{
		.size = 1,
		.bit = 0,
...
const size_t uvc_control_map_su_len = ARRAY_SIZE(uvc_control_map_su);

const struct uvc_control_map uvc_control_map_xu[] = {
	{
		.size = 4,
		.bit = 0,
...
const size_t uvc_control_map_xu_len = ARRAY_SIZE(uvc_control_map_xu);

/* Convert back and forth between UVC format GUIDs and video FourCCs */
