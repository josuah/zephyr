...
{
	mp_value_t bt = mp_value_new(MP_TYPE_BOOLEAN, true);
	...
	mp_value_t bf = mp_value_new(MP_TYPE_BOOLEAN, false);
	...
	mp_value_t el = mp_value_new(MP_TYPE_LIST, NULL);
...
ZTEST(mp_value_api, test_list)
{
	...
	mp_value_t item1 = mp_value_new(MP_TYPE_INT, 10);
	mp_value_t item2 = mp_value_new(MP_TYPE_INT, 20);
...
{
	mp_value_t a10 = mp_value_new(MP_TYPE_INT, 10);
	mp_value_t b10 = mp_value_new(MP_TYPE_INT, 10);
	mp_value_t b20 = mp_value_new(MP_TYPE_INT, 20);
	mp_value_t b100 = mp_value_new(MP_TYPE_INT, 100);
	mp_value_t a100 = mp_value_new(MP_TYPE_INT, 100);
...
{
	mp_value_t a = mp_value_new(MP_TYPE_INT, 48000);
	mp_value_t b = mp_value_new(MP_TYPE_INT, 48000);
...
ZTEST(mp_value_api, test_duplicate_and_is_primitive)
{
	...
	mp_value_t iv = mp_value_new(MP_TYPE_INT, 1);

	zassert_true(mp_value_is_primitive(iv), "INT not primitive");
	mp_value_destroy(iv);

	mp_value_t bv = mp_value_new(MP_TYPE_BOOLEAN, true);

	zassert_true(mp_value_is_primitive(bv), "BOOLEAN not primitive");
	mp_value_destroy(bv);

	mp_value_t lv = mp_value_new(MP_TYPE_LIST, NULL);
	...
	mp_value_t ci_a = mp_value_new(MP_TYPE_INT, 10);
	mp_value_t ci_b = mp_value_new(MP_TYPE_INT, 10);
...
{
	mp_value_t val = mp_value_new(MP_TYPE_INT, 10);
...
{
	mp_value_t int_val = mp_value_new(MP_TYPE_INT, 42);
	mp_value_t str_val = mp_value_new(MP_TYPE_STRING, "hello");
	...
	mp_value_t a = mp_value_new(MP_TYPE_INT, 100);
	mp_value_t b = mp_value_new(MP_TYPE_INT, 200);
	mp_value_t result = mp_value_intersect(a, b);
