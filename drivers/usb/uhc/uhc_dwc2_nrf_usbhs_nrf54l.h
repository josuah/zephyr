...
static inline bool usbhs_core_is_enabled(NRF_USBHS_Type *wrapper)
{
	return (wrapper->ENABLE & USBHS_ENABLE_CORE_Msk) != 0U;
}
...
static inline int usbhs_pre_init(const struct device *dev)
{
	...
	wrapper->PHY.INPUTOVERRIDE =
		USBHS_PHY_INPUTOVERRIDE_ID_Msk |
		USBHS_PHY_INPUTOVERRIDE_VBUSVALID_Msk |
		USBHS_PHY_INPUTOVERRIDE_DMPULLDOWN_Msk |
		USBHS_PHY_INPUTOVERRIDE_DPPULLDOWN_Msk;
	wrapper->PHY.OVERRIDEVALUES =
		USBHS_PHY_OVERRIDEVALUES_DMPULLDOWN_Msk |
		USBHS_PHY_OVERRIDEVALUES_DPPULLDOWN_Msk;
