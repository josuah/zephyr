...
static inline usb_dwc2_grxfsiz_reg_t dwc2_ll_grxfsiz_read_reg(const struct usb_dwc2_reg *const dwc2)
{
	usb_dwc2_grxfsiz_reg_t reg;
	reg.val = sys_read32((mem_addr_t)&dwc2->grxfsiz);
	return reg;
}

static inline void dwc2_ll_grxfsiz_set_rx_fifo_depth(struct usb_dwc2_reg *const dwc2, uint32_t rx_fifo_depth)
{
...
static inline usb_dwc2_gnptxfsiz_reg_t dwc2_ll_gnptxfsiz_read_reg(const struct usb_dwc2_reg *const dwc2)
{
	usb_dwc2_gnptxfsiz_reg_t reg;
	reg.val = sys_read32((mem_addr_t)&dwc2->gnptxfsiz);
	return reg;
}

static inline void dwc2_ll_gnptxfsiz_set_nptx_fifo_start_addr(struct usb_dwc2_reg *const dwc2, uint32_t nptx_fifo_addr)
{
...
static inline void dwc2_ll_gnptxfsiz_set_nptx_fifo_depth(struct usb_dwc2_reg *const dwc2, uint32_t nptx_fifo_depth)
{
	usb_dwc2_gnptxfsiz_reg_t gnptxfsiz_reg;
	gnptxfsiz_reg.val = sys_read32((mem_addr_t)&dwc2->gnptxfsiz);
...
static inline usb_dwc2_gdfifocfg_reg_t dwc2_ll_gdfifocfg_read_reg(const struct usb_dwc2_reg *const dwc2)
{
	usb_dwc2_gdfifocfg_reg_t reg;
	reg.val = sys_read32((mem_addr_t)&dwc2->gdfifocfg);
	return reg;
}

static inline void dwc2_ll_gdfifocfg_set_ep_info_base_addr(struct usb_dwc2_reg *const dwc2, uint32_t addr)
{
...
static inline void dwc2_ll_gdfifocfg_set_gdfifo_cfg(struct usb_dwc2_reg *const dwc2, uint32_t gdfifo_cfg)
{
	usb_dwc2_gdfifocfg_reg_t gdfifocfg_reg;
	gdfifocfg_reg.val = sys_read32((mem_addr_t)&dwc2->gdfifocfg);
...
static inline usb_dwc2_hptxfsiz_reg_t dwc2_ll_hptxfsiz_read_reg(const struct usb_dwc2_reg *const dwc2)
{
	usb_dwc2_hptxfsiz_reg_t reg;
	reg.val = sys_read32((mem_addr_t)&dwc2->hptxfsiz);
	return reg;
}

static inline void dwc2_ll_hptxfsiz_set_host_tx_fifo_start_addr(struct usb_dwc2_reg *const dwc2, uint32_t hptx_fifo_addr)
{
...
static inline void dwc2_ll_hptxfsiz_set_host_tx_fifo_depth(struct usb_dwc2_reg *const dwc2, uint32_t hptx_fifo_depth)
{
	usb_dwc2_hptxfsiz_reg_t hptxfsiz_reg;
	hptxfsiz_reg.val = sys_read32((mem_addr_t)&dwc2->hptxfsiz);
