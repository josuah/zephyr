...
#define USB_DWC2_GUSBCFG_ULPIEVBUSI_POS		21UL
#define USB_DWC2_GUSBCFG_ULPIEVBUSI		BIT(USB_DWC2_GUSBCFG_ULPIEVBUSI_POS)
...
#define USB_DWC2_GUSBCFG_PHYLPCLK_SEL_POS	15UL
#define USB_DWC2_GUSBCFG_PHYLPCLK_SEL_LP	BIT(USB_DWC2_GUSBCFG_PHYLPCLK_SEL_POS)
...
USB_DWC2_GET_FIELD_DEFINE(hptxfsiz_ptxfsize, HPTXFSIZ_PTXFSIZE)
USB_DWC2_GET_FIELD_DEFINE(hptxfsiz_ptxfstaddr, HPTXFSIZ_PTXFSTADDR)
USB_DWC2_SET_FIELD_DEFINE(hptxfsiz_ptxfsize, HPTXFSIZ_PTXFSIZE)
USB_DWC2_SET_FIELD_DEFINE(hptxfsiz_ptxfstaddr, HPTXFSIZ_PTXFSTADDR)
...
#define USB_DWC2_HCFG_FRLISTEN_ENTRY64		3
#define USB_DWC2_HCFG_FRLISTEN_ENTRY32		2
#define USB_DWC2_HCFG_FRLISTEN_ENTRY16		1
#define USB_DWC2_HCFG_FRLISTEN_ENTRY8		0
...
#define USB_DWC2_HCFG_FSLSPCLKSEL_CLK6		2
#define USB_DWC2_HCFG_FSLSPCLKSEL_CLK48		1
#define USB_DWC2_HCFG_FSLSPCLKSEL_CLK3060	0
...
#define USB_DWC2_HFNUM				0x0408UL

#define USB_DWC2_HFNUM_FRREM_POS		16UL
#define USB_DWC2_HFNUM_FRREM_MASK		(0xFFFFUL << USB_DWC2_HFNUM_FRREM_POS)
#define USB_DWC2_HFNUM_FRNUM_POS		0UL
#define USB_DWC2_HFNUM_FRNUM_MASK		(0xFFFFUL << USB_DWC2_HFNUM_FRNUM_POS)

USB_DWC2_GET_FIELD_DEFINE(hfnum_frrem, HFNUM_FRREM)
USB_DWC2_SET_FIELD_DEFINE(hfnum_frnum, HFNUM_FRNUM)

/* Host All Channels Interrupt Register */
#define USB_DWC2_HAINT				0x0414UL
#define USB_DWC2_HAINT_HAINT_POS		0UL
#define USB_DWC2_HAINT_HAINT_MASK		(0xFFFFUL << USB_DWC2_HAINT_HAINT_POS)
...
#define USB_DWC2_HPRT_PRTTSTCTL_TESTFENB	5
#define USB_DWC2_HPRT_PRTTSTCTL_TESTPM		4
#define USB_DWC2_HPRT_PRTTSTCTL_TESTSN		3
#define USB_DWC2_HPRT_PRTTSTCTL_TESTK		2
#define USB_DWC2_HPRT_PRTTSTCTL_TESTJ		1
#define USB_DWC2_HPRT_PRTTSTCTL_DISABLED	0
#define USB_DWC2_HPRT_PRTPWR_POS		12UL
#define USB_DWC2_HPRT_PRTPWR			BIT(USB_DWC2_HPRT_PRTPWR_POS)
#define USB_DWC2_HPRT_PRTLNSTS_POS		10UL
#define USB_DWC2_HPRT_PRTLNSTS_MASK		(0x3UL << USB_DWC2_HPRT_PRTLNSTS_POS)
#define USB_DWC2_HPRT_PRTRST_POS		8UL
#define USB_DWC2_HPRT_PRTRST			BIT(USB_DWC2_HPRT_PRTRST_POS)
#define USB_DWC2_HPRT_PRTSUSP_POS		7UL
#define USB_DWC2_HPRT_PRTSUSP			BIT(USB_DWC2_HPRT_PRTSUSP_POS)
#define USB_DWC2_HPRT_PRTRES_POS		6UL
#define USB_DWC2_HPRT_PRTRES			BIT(USB_DWC2_HPRT_PRTRES_POS)
#define USB_DWC2_HPRT_PRTOVRCURRCHNG_POS	5UL
#define USB_DWC2_HPRT_PRTOVRCURRCHNG		BIT(USB_DWC2_HPRT_PRTOVRCURRCHNG_POS)
#define USB_DWC2_HPRT_PRTOVRCURRACT_POS		4UL
#define USB_DWC2_HPRT_PRTOVRCURRACT		BIT(USB_DWC2_HPRT_PRTOVRCURRACT_POS)
#define USB_DWC2_HPRT_PRTENCHNG_POS		3UL
#define USB_DWC2_HPRT_PRTENCHNG			BIT(USB_DWC2_HPRT_PRTENCHNG_POS)
#define USB_DWC2_HPRT_PRTENA_POS		2UL
#define USB_DWC2_HPRT_PRTENA			BIT(USB_DWC2_HPRT_PRTENA_POS)
#define USB_DWC2_HPRT_PRTCONNDET_POS		1UL
#define USB_DWC2_HPRT_PRTCONNDET		BIT(USB_DWC2_HPRT_PRTCONNDET_POS)
#define USB_DWC2_HPRT_PRTCONNSTS_POS		0UL
#define USB_DWC2_HPRT_PRTCONNSTS		BIT(USB_DWC2_HPRT_PRTCONNSTS_POS)
...
/* Host Channel0 Characteristics Register offset */
#define USB_DWC2_HCCHAR0			0x0500UL

/* Host Channel Characteristics Registers
 * offsets 0x0500 + (0x20 * n), n = 0 .. x
 */
#define USB_DWC2_HCCHAR(n)			(USB_DWC2_HCCHAR0 + ((n) * 0x20UL))

/* Bitfield Masks */
#define USB_DWC2_HCCHAR_CHENA_POS		31UL
#define USB_DWC2_HCCHAR_CHENA			BIT(USB_DWC2_HCCHAR_CHENA_POS)
#define USB_DWC2_HCCHAR_CHDIS_POS		30UL
#define USB_DWC2_HCCHAR_CHDIS			BIT(USB_DWC2_HCCHAR_CHDIS_POS)
#define USB_DWC2_HCCHAR_ODDFRM_POS		29UL
#define USB_DWC2_HCCHAR_ODDFRM			BIT(USB_DWC2_HCCHAR_ODDFRM_POS)
#define USB_DWC2_HCCHAR_DEVADDR_POS		22UL
#define USB_DWC2_HCCHAR_DEVADDR_MASK		(0x7FUL << USB_DWC2_HCCHAR_DEVADDR_POS)
#define USB_DWC2_HCCHAR_EC_POS			20UL
#define USB_DWC2_HCCHAR_EC_MASK			(0x3UL << USB_DWC2_HCCHAR_EC_POS)
#define USB_DWC2_HCCHAR_EPTYPE_POS		18UL
#define USB_DWC2_HCCHAR_EPTYPE_MASK		(0x3UL << USB_DWC2_HCCHAR_EPTYPE_POS)
#define USB_DWC2_HCCHAR_LSPDDEV_POS		17UL
#define USB_DWC2_HCCHAR_LSPDDEV			BIT(USB_DWC2_HCCHAR_LSPDDEV_POS)
#define USB_DWC2_HCCHAR_EPDIR_POS		15UL
#define USB_DWC2_HCCHAR_EPDIR			BIT(USB_DWC2_HCCHAR_EPDIR_POS)
#define USB_DWC2_HCCHAR_EPNUM_POS		11UL
#define USB_DWC2_HCCHAR_EPNUM_MASK		(0xFUL << USB_DWC2_HCCHAR_EPNUM_POS)
#define USB_DWC2_HCCHAR_MPS_POS			0UL
#define USB_DWC2_HCCHAR_MPS_MASK		(0x7FFUL << USB_DWC2_HCCHAR_MPS_POS)

USB_DWC2_GET_FIELD_DEFINE(hcchar_devaddr, HCCHAR_DEVADDR)
USB_DWC2_GET_FIELD_DEFINE(hcchar_ec, HCCHAR_EC)
USB_DWC2_GET_FIELD_DEFINE(hcchar_eptype, HCCHAR_EPTYPE)
USB_DWC2_GET_FIELD_DEFINE(hcchar_epnum, HCCHAR_EPNUM)
USB_DWC2_GET_FIELD_DEFINE(hcchar_mps, HCCHAR_MPS)
USB_DWC2_SET_FIELD_DEFINE(hcchar_devaddr, HCCHAR_DEVADDR)
USB_DWC2_SET_FIELD_DEFINE(hcchar_ec, HCCHAR_EC)
USB_DWC2_SET_FIELD_DEFINE(hcchar_eptype, HCCHAR_EPTYPE)
USB_DWC2_SET_FIELD_DEFINE(hcchar_epnum, HCCHAR_EPNUM)
USB_DWC2_SET_FIELD_DEFINE(hcchar_mps, HCCHAR_MPS)

/*
 * Host Channel Interrupt Registers (HCINT)
 * offsets 0x0508 + (0x20 * n), n = 0 .. x
 */
#define USB_DWC2_HCINT0				0x0508UL

#define USB_DWC2_HCINT_DESC_LST_ROLL_POS	13UL
#define USB_DWC2_HCINT_DESC_LST_ROLL		BIT(USB_DWC2_HCINT_DESC_LST_ROLL_POS)
#define USB_DWC2_HCINT_BNA_POS			11UL
#define USB_DWC2_HCINT_BNA			BIT(USB_DWC2_HCINT_BNA_POS)
#define USB_DWC2_HCINT_DTGERR_POS		10UL
#define USB_DWC2_HCINT_DTGERR			BIT(USB_DWC2_HCINT_DTGERR_POS)
#define USB_DWC2_HCINT_FRMOVRUN_POS		9UL
#define USB_DWC2_HCINT_FRMOVRUN			BIT(USB_DWC2_HCINT_FRMOVRUN_POS)
#define USB_DWC2_HCINT_BBLERR_POS		8UL
#define USB_DWC2_HCINT_BBLERR			BIT(USB_DWC2_HCINT_BBLERR_POS)
#define USB_DWC2_HCINT_XACTERR_POS		7UL
#define USB_DWC2_HCINT_XACTERR			BIT(USB_DWC2_HCINT_XACTERR_POS)
#define USB_DWC2_HCINT_NYET_POS			6UL
#define USB_DWC2_HCINT_NYET			BIT(USB_DWC2_HCINT_NYET_POS)
#define USB_DWC2_HCINT_ACK_POS			5UL
#define USB_DWC2_HCINT_ACK			BIT(USB_DWC2_HCINT_ACK_POS)
#define USB_DWC2_HCINT_NAK_POS			4UL
#define USB_DWC2_HCINT_NAK			BIT(USB_DWC2_HCINT_NAK_POS)
#define USB_DWC2_HCINT_STALL_POS		3UL
#define USB_DWC2_HCINT_STALL			BIT(USB_DWC2_HCINT_STALL_POS)
#define USB_DWC2_HCINT_AHBERR_POS		2UL
#define USB_DWC2_HCINT_AHBERR			BIT(USB_DWC2_HCINT_AHBERR_POS)
#define USB_DWC2_HCINT_CHHLTD_POS		1UL
#define USB_DWC2_HCINT_CHHLTD			BIT(USB_DWC2_HCINT_CHHLTD_POS)
#define USB_DWC2_HCINT_XFERCOMPL_POS		0UL
#define USB_DWC2_HCINT_XFERCOMPL		BIT(USB_DWC2_HCINT_XFERCOMPL_POS)

/*
 * Host Channel Interrupt Mask Registers
 * offsets 0x050C + (0x20 * n), n = 0 .. x
 */
#define USB_DWC2_HCINTMSK0			0x050CUL

/* Host Channel Transfer Size Registers
 * offsets 0x0510 + (0x20 * n), n = 0 .. x
 */
#define USB_DWC2_HCTSIZ0			0x0510UL

#define USB_DWC2_HCTSIZ_DOPNG_POS		31UL
#define USB_DWC2_HCTSIZ_DOPNG			BIT(USB_DWC2_HCTSIZ_DOPNG_POS)
#define USB_DWC2_HCTSIZ_PID_POS			29UL
#define USB_DWC2_HCTSIZ_PID_MASK		(0x3UL << USB_DWC2_HCTSIZ_PID_POS)
#define USB_DWC2_HCTSIZ_PID_MDATA		3
#define USB_DWC2_HCTSIZ_PID_SETUP		3
#define USB_DWC2_HCTSIZ_PID_DATA1		2
#define USB_DWC2_HCTSIZ_PID_DATA2		1
#define USB_DWC2_HCTSIZ_PID_DATA0		0
...
/* Host Channel DMA Address Registers
 * offsets 0x0514 + (0x20 * n), n = 0 .. x
 */
#define USB_DWC2_HCDMA0				0x0514UL

/* Host Channel DMA Buffer Address Registers
 * offsets 0x051C + (0x20 * n), n = 0 .. x
 */
