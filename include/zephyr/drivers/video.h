 ...
 * A driver might want to decide handle the non-standard types before calling this function.
 *
 * The YUYV and UYVY formats are both mapped to @ref VIDEO_MIPI_CSI2_DT_YUV422_8.
 *
