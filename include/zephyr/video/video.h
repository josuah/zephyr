...
/**
 * @brief Video subsystem public APIs.
 * @defgroup video_api Video Subsystem
 * @ingroup multimedia
 * @since 4.4
 * @version 0.2.0
 * @{
...
/**
 * @brief Functions handle allocation and exchange of video buffers
...
/**
 * @brief Get a video buffer from a video device.
 *
 * Dequeue an empty (output) or filled (capturing) video buffer in the driver’s
...
/**
 * @brief APIs for manipulating video controls
 * @defgroup video_api_control Video Controls
 * @{
 */
