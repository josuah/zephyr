...
The ``ai_m61_32s`` board uses UART0 as default serial port.  It is connected
...
#. Run your favorite terminal program to listen for output. Under Linux the
   ...
   .. code-block:: console
      ...
      *** Booting Zephyr OS build v4.2.0 ***
      Hello World! ai_m61_32s/bl618c50q2i

Congratulations, you have ``ai_m61_32s`` configured and running Zephyr.


.. _Bouffalo Lab BL61x MCU Datasheet:
	https://github.com/bouffalolab/bl_docs/tree/main/BL618_DS/en

.. _Bouffalo Lab Development Zone:
	https://dev.bouffalolab.com/home?id=guest

.. _ai_m61_32s Schematics:
